      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-2 md:grid-cols-4 gap-10">
        <div className="col-span-2">
          ...
          <p className="text-zinc-400 mt-4 max-w-sm text-sm leading-relaxed">
            Level up your skills with world-class courses from expert
            instructors. Learn on your terms, anywhere, anytime.
          </p>
          <div className="flex gap-3 mt-6">
            {[Twitter, Github, Youtube].map((I, i) => (
              <div
                key={i}
                className="h-9 w-9 grid place-items-center rounded-full border border-zinc-800 hover:border-[#FFD60A] hover:text-[#FFD60A] transition-colors cursor-pointer"
              >
                <I className="h-4 w-4" />
              </div>
            ))}
