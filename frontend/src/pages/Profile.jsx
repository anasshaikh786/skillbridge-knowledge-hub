...
export default function Profile() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-10 py-14">
      <h1 className="font-display font-black text-4xl tracking-tighter text-white">
        Your Profile
      </h1>
      ...
      <div className="mt-10 bg-[#121214] border border-zinc-800/60 rounded-2xl p-8">
        ...
        >
          ...
          <div className="md:col-span-2">
            <Button
              type="submit"
              className="rounded-full bg-[#FFD60A] text-black hover:bg-[#FFC300] font-bold"
        ...
        >
          ...
          <div className="md:col-span-2">
            <Button
              type="submit"
              className="rounded-full bg-[#FFD60A] text-black hover:bg-[#FFC300] font-bold"
              data-testid="profile-changepw-btn"
            >
              Change password
            </Button>
          </div>
      ...
      <div className="mt-6 bg-red-500/5 border border-red-900/40 rounded-2xl p-8">
        <h3 className="font-display font-bold text-red-400 text-xl mb-2">
          Danger zone
        </h3>
...
const inp =
  "h-11 bg-zinc-900 border-zinc-800 rounded-xl text-white focus-visible:ring-[#FFD60A] focus-visible:ring-offset-0";
